        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TCNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassFloor = table.Column<byte>(type: "tinyint", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.TCNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teachers", x => x.TCNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Children_Mothers_MotherId",
                        column: x => x.MotherId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherTCNumber = table.Column<string>(type: "nvarchar(11)", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FinishDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Capasite = table.Column<int>(type: "int", nullable: false),
                    PortalCode = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseGroups_Teachers_TeacherTCNumber",
                        column: x => x.TeacherTCNumber,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NeighbourhoodName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StudentsCourseGroups",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentTCNumber = table.Column<string>(type: "nvarchar(11)", nullable: true),
                    CourseGroupId = table.Column<int>(type: "int", nullable: false),
                    IsGraduated = table.Column<bool>(type: "bit", nullable: false),
                    GraduationScore = table.Column<double>(type: "float", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsCourseGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentsCourseGroups_CourseGroups_CourseGroupId",
                        column: x => x.CourseGroupId,
                        principalTable: "CourseGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsCourseGroups_Students_StudentTCNumber",
                        column: x => x.StudentTCNumber,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersAddresses_Neighbourhoods_NeighbourhoodId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentsCourseGroupId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAttendances_StudentsCourseGroups_StudentsCourseGroupId",
                        column: x => x.StudentsCourseGroupId,
                        principalTable: "StudentsCourseGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseGroups_PortalCode",
                table: "CourseGroups",
                column: "PortalCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseGroups_TeacherTCNumber",
                table: "CourseGroups",
                column: "TeacherTCNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttendances_StudentsCourseGroupId",
                table: "StudentAttendances",
                column: "StudentsCourseGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsCourseGroups_CourseGroupId",
                table: "StudentsCourseGroups",
                column: "CourseGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsCourseGroups_StudentTCNumber",
                table: "StudentsCourseGroups",
                column: "StudentTCNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersAddresses_NeighbourhoodId",
